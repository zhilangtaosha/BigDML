...
Grid search is used to find the best parameters for SVM and KNearest classifiers. # 利用网格搜索进行了参数优化
SVM adjustment follows the guidelines given in
http://www.csie.ntu.edu.tw/~cjlin/papers/guide/guide.pdf

Threading or cloud computing (with http://www.picloud.com/)) may be used to speedup the computation.
