...
sys.path.append("E:\\Code\\SVN\\trunk\\Python\\data\\openflights-master\\data")

#（1）数据导入.
import pandas

# Read in the airports data.
airports=pandas.read_csv("E:\\Code\\SVN\\trunk\\Python\\data\\openflights-master\\data\\airports.dat",header=None,dtype=str) # 按字符串读取
airports.columns=["id","name","city","country","code","icao","latitude","longitude","altitude","offset","dst","timezone"] #设置列名

# Read in the airlines data.
airlines=pandas.read_csv("E:\\Code\\SVN\\trunk\\Python\\data\\openflights-master\\data\\airlines.dat",header=None,dtype=str)
airlines.columns=["id","name","alias","iata","icao","callsign","country","active"]

# Read in the routes data.
routes=pandas.read_csv("E:\\Code\\SVN\\trunk\\Python\\data\\openflights-master\\data\\routes.dat",header=None,dtype=str)
